...
void key_detection(void) {
    ...
    long temp_code;
    if (check == 0b010000000000) {
        temp_code = (final_code & 0b010100100000);
        ...
        temp_code = (final_code & 0b010100010000);
        ...
        temp_code = (final_code & 0b010010010000);
        if (temp_code == 0b010010010000) {
            input = 1;
            inputChanged = 1;
        }

        temp_code = final_code & 0b010100001000;
        if (temp_code == 0b010100001000) {
            input = 2;
            inputChanged = 1;
        }

        temp_code = final_code & 0b010010100000;
        if (temp_code == 0b010010100000) {
            input = 3;
            inputChanged = 1;
        }

        temp_code = final_code & 0b010010001000;
